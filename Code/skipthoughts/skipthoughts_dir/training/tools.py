...
from training.encoder_utils import load_params, init_tparams
from training.model import init_params, build_encoder, build_encoder_w2v

#-----------------------------------------------------------------------------#
# Specify model and dictionary locations here
#-----------------------------------------------------------------------------#
path_to_model = '../aux_data/toy.npz'
path_to_dictionary = '../aux_data/dummy.dict'
path_to_word2vec = '../aux_data/GoogleNews-vectors-negative300.bin'
#-----------------------------------------------------------------------------#
